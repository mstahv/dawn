...
public class CdnFonts implements javax.servlet.http.HttpSessionListener {
    ...
    private boolean inited = "true".equals(System.getProperty(
            "skipDawnCloudFonts"));
    ...
    public void sessionCreated(HttpSessionEvent se) {
        if (!inited) {
            try {
                    ...
                    public void sessionInit(SessionInitEvent event) throws ServiceException {
                        VaadinSession.getCurrent().addBootstrapListener(
                            ...
                            public void modifyBootstrapPage(
                                ...
                                Element head = document.getElementsByTag("head").
                                        first();
                ...
                // This happens in e.g. Portal, but is typically not critical.
                Logger.getLogger(CdnFonts.class.getName()).log(Level.FINE,
                        "Could not set cdn font files",
                        e);
            }
        }
    }
